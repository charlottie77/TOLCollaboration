<template>
  <div class="check-answer">
    ...
    <div class="section-a">
      ...
      <div class="section-a-q1-e">
        <label>Explanation</label>
        <p>Correct! There is no memory effect in lithium batteries compared with traditional batteries.</p>
      </div>
      ...
      <div class="section-a-q3">
        ...
        <div class="section-a-q3-e">
        <label>Explanation</label>
        <p>Correct! There is no memory effect in lithium batteries compared with traditional batteries.</p>
      </div>
      </div>
    </div>
    <div class="check-point-button">
      <router-link to="/doc"> <button>Next</button></router-link>
    </div>
  </div>
</template>
